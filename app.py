...
# To save a local Assistant model we need to uncomment this next line. assistant.save_model. The name to model will be generated by default.
# assistant.save_model()

# The save model creates following three files in localhost.  
# assistant_model.h5
# assistant_model_classes.pkl
# assistant_model_words.pkl

# To load a local Assistant model we need to uncomment this next line. assistant.save_model. Remember to comment above two lines if loading a predefined model. 
# comment assistant.train_model() and assistant.save_model() and uncomment next line to load a default. 
